export const createStampCard = function (url, title, createdAt) {
  ...
  stampCardElement.style.display = 'flex';
  stampCardElement.style.flexFlow = 'column';
  stampCardElement.style.alignItems = 'center';
...
export const createNoteCard = function (url, title, createdBy, onclick) {
  ...
  noteCardElement.style.display = 'flex';
  noteCardElement.style.flexFlow = 'column';
  noteCardElement.style.alignItems = 'center';
